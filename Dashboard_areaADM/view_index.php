			...
			<div class="row">
				<div class="col-xl-3 col-sm-6 mb-3">
					<div class="card text-white bg-success o-hidden h-100">
						...
						<a href="view_lista_usuario.php" class="card-footer text-white clearfix small z-1">
							<span class="float-left"> Ver Lista de usuarios</span>
				...
				<div class="col-xl-3 col-sm-6 mb-3">
					<div class="card text-white bg-warning o-hidden h-100">
						...
						<a href="#" class="card-footer text-white clearfix small z-1">
							<span class="float-left"> Ver Alertas</span>
							<span class="float-right">
								<i class="fa fa-angle-right"></i>
							</span>
						</a>
				...
				<div class="col-xl-3 col-sm-6 mb-3">
					<div class="card text-white bg-danger o-hidden h-100">
						...
						<a href="view_denuncias.php" class="card-footer text-white clearfix small z-1">
							<span class="float-left"> Ver Denuncias</span>
							<span class="float-right">
								<i class="fa fa-angle-right"></i>
							</span>
						</a>
