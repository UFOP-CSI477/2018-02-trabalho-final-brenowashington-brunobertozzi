		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="far fa-calendar-plus"></i> Registrar novo usuario
				</div>
				<div class="card-body">
					<form>
						<div class="form-group">
							<div class="form-row">
								...
								<div class="col-md-6">
									<label for="emailcadastro">Digite o E-mail:</label>
									<input type="email" name="emailcadastro" id="emailcadastro" class="form-control"
									placeholder="Digite o E-mail valido">
								</div>
						...
						<div class="form-group">
							<button type="submit" name="Cadastrar" id="efetuarcadastro" class="btn btn-primary "> Criar Conta</button>	
						</div>
					</form>
				</div>
			</div>
