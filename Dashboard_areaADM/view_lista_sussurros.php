<?php 
	...
	$sussurros = $connection -> query("SELECT * FROM sussurros");
		...
		<div class="container-fluid">
			...
			<div class="card mb-3">
				<div class="card-header">
					<i class="fas fa-comment-dots"></i> Lista de Sussurros
				</div>
				<div class="card-body">
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<thead>
							<tr>
								<th>Codigo sussurro</th>
								<th>Texto</th>
								<th>Id remetente</th>
						...
						<tbody>
								...
								<?php
									while ($sussurro = $sussurros->fetch()){
										echo "<tr>";
										echo"<th>".$sussurro["cod_sussurro"]."</th>";
										echo"<th>".$sussurro["texto"]."</th>";
										echo"<th>".$sussurro["id_remetente"]."</th>";
										echo"<th>".$sussurro["id_dest"]."</th>";
										echo "</tr>";
									}
								?>
