...
<head>
	...
	<title>Area Administrativa - Recuperar Senha</title>
		...
		<div class="card card-login mx-auto mt-5">
			...
			<div class="card-body">
				...
				<form>
					...
					<button class="btn botao btn-block">
					...
					<div class="text-center">
						<a href="#" class="d-block small mt-3">Registrar-se</a>	
						<a href="#" class="d-block small ">Pagina Login</a>	
					</div>				
				</form>
			</div>
		</div>
